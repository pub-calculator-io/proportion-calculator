...
Version: 1.0.0
Author: Proportion Calculator  / www.calculator.io
...
function display_calcio_ci_proportion_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_proportion_calculator', 'display_calcio_ci_proportion_calculator' );